...
@Component({
  selector: 'app-vertical-menu-aff',
  templateUrl: './vertical-menu-aff.component.html',
  styleUrls: ['./vertical-menu-aff.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ MenuService ]
})
export class VerticalMenuAffComponent implements OnInit {
