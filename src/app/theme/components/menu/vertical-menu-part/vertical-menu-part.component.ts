...
@Component({
  selector: 'app-vertical-menu-part',
  templateUrl: './vertical-menu-part.component.html',
  styleUrls: ['./vertical-menu-part.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ MenuService ]
})
export class VerticalMenuPartComponent implements OnInit {
