...
import { verticalMenuItems, verticalaffitems, verticalventeitems } from './menu';
...
export class MenuService {
  constructor(private location: Location,
    ...
    private lang: LanguageService,private dialog:MatDialog) { }
  ...
  public getVerticalaffitems(): Array<Menu> {
    return verticalaffitems;
  }
  public getVerticalventeitems(): Array<Menu> {
    return verticalventeitems;
  }
  ...
  public createVerticalMenuItem(menu: Array<Menu>, menuItem) {
    ...
    this.renderer2.setAttribute(link, 'data-original-title', this.lang.getlang(menuItem.title));
    ...
    let menuText = this.renderer2.createText(this.lang.getlang(menuItem.title));
  ...
  public popup(menuItem){
  if(menuItem.func=='cloture'){
    console.log('cloture!!!!!!!!!!!!!!!!!!!!');
  }
  else{
  ...
  public getActiveLink(menu: Array<Menu>) {
    ...
    if (activeMenuItem[0]) {
     ...
     // console.log(activeMenuItem[0].title);
      return activeLink;
    }
    return false;
  }
